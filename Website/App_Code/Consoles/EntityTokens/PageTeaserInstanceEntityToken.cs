...
namespace Consoles.EntityTokens
{
    ...
    public class PageTeaserInstanceEntityToken : EntityToken
    {
        ...
        public Country Teaser
        {
            get
            {
                ...
                return DataFacade.GetData(type).Cast<Country>().Single(t => t.Id == id);
            }
        }

        public PageTeaserInstanceEntityToken(IPage page, Country teaser)
        {
        ...
        public static EntityToken Deserialize(string serializedEntityToken)
        {
            ...
            var teaser = DataFacade.GetData(TypeManager.GetType(type)).Cast<Country>().Single(t => t.Id == new Guid(id));
    ...
    public class FormInstanceAncestorProvider : ISecurityAncestorProvider
    {
        public IEnumerable<EntityToken> GetParents(EntityToken entityToken)
        {
            ...
            if (teaserInstanceToken != null)
            {
                ...
                yield return new PageTeaserPositionFolderEntityToken(teaserInstanceToken.Page, teaser.Code);
            }
        }
    }
}
